class CreateOrUpdateDocumentsSwiftype
  attr_reader :post
  ...
  def run  
    ...
    client.create_or_update_document(ENV['SWIFTYPE_ENGINE_SLUG'],
                                     Post.model_name.downcase, #This assumes that the your engine uses "post" as a document type. You can replace it with any document type defined in your engine
                                     {:external_id => post.id,
